...
const TABS = [
  { to: '/', label: 'Dia', icon: 'calendario' as const },
  { to: '/historico', label: 'Histórico', icon: 'calendario' as const },
  { to: '/relatorios', label: 'Relatórios', icon: 'grafico' as const },
  { to: '/config', label: 'Config', icon: 'engrenagem' as const },
]
      ...
      {TABS.slice(0, 2).map((tab, i) => {
        ...
        return (
          <button
            ...
            style={s(isDark).tab}
          >
            {isActive && <span style={s(isDark).pill} />}
