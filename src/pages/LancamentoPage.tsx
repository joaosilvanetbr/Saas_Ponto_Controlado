...
export default function LancamentoPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const dados: import('../types').Ponto = {
        user_id: user.id,
        data,
        tipo: isCorrecao ? 'registro' : tipo as import('../types').Ponto['tipo'],
        obs: obs || undefined,
        marcacoes: [],
        entrada1: '',
        saida1: '',
      ...
      if (existente && !isCorrecao && existente.tipo === 'registro') {
        dados.entrada1 = existente.entrada1 || ''
        dados.saida1 = existente.saida1 || ''
        dados.entrada2 = existente.entrada2 || ''
        dados.saida2 = existente.saida2 || ''
      }
  ...
  return (
    <AppLayout title="Lançar">
      ...
      <Button variant="filled" size="lg" fullWidth onClick={() => { void handleSubmit({ preventDefault: () => {} } as FormEvent) }} disabled={mesBloqueado || loading || !data}>
