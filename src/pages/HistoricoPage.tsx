...
import type { ConfigUsuario, Ponto, Marcacao } from '../types'
...
export default function HistoricoPage() {
  ...
  function calcularHorasPonto(ponto: import('../types').Ponto): number {
  ...
  function calcularSaldoPonto(ponto: import('../types').Ponto): number {
